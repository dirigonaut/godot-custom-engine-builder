...
BUILD_WINDOWS=$(if printf '%s\0' "${OPERATING_SYSTEMS[@]}" | grep -Fqwz -- "windows"; then echo 1; else echo 0; fi;)
BUILD_MACOS=$(if printf '%s\0' "${OPERATING_SYSTEMS[@]}" | grep -Fqwz -- "macos"; then echo 1; else echo 0; fi;)
BUILD_WEB=$(if printf '%s\0' "${OPERATING_SYSTEMS[@]}" | grep -Fqwz -- "web"; then echo 1; else echo 0; fi;)
BUILD_ANDROID=$(if printf '%s\0' "${OPERATING_SYSTEMS[@]}" | grep -Fqwz -- "android"; then echo 1; else echo 0; fi;)
BUILD_IOS=$(if printf '%s\0' "${OPERATING_SYSTEMS[@]}" | grep -Fqwz -- "ios"; then echo 1; else echo 0; fi;)

BUILD_X86_32=$(if printf '%s\0' "${ARCHITECTURE[@]}" | grep -Fqwz -- "x86_32"; then echo 1; else echo 0; fi;)
BUILD_X86_64=$(if printf '%s\0' "${ARCHITECTURE[@]}" | grep -Fqwz -- "x86_64"; then echo 1; else echo 0; fi;)
BUILD_ARM_32=$(if printf '%s\0' "${ARCHITECTURE[@]}" | grep -Fqwz -- "arm32"; then echo 1; else echo 0; fi;)
BUILD_ARM_64=$(if printf '%s\0' "${ARCHITECTURE[@]}" | grep -Fqwz -- "arm64"; then echo 1; else echo 0; fi;)
